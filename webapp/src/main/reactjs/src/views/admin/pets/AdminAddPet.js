                ...
                return (
                    <Form>
                        ...
                        >
                            <Input
                                name={"petName"}
                                placeholder={t("form.petName.placeholder")}
                            />
                        </FormItem>
                        ...
                        >
                            <Checkbox
                                name={"isAdoption"}
                                onChange={() => setFieldValue("price", 0)}
                            />
                        </FormItem>
                        ...
                        <FormItem name={"user"} label={t("form.userId.label")}>
                            <Select
                                name={"user"}
                                placeholder={t("form.userId.label")}
                            >
                                {users &&
                                    users.map((user) => {
                                        return (
                        ...
                        <FormItem name={"breed"} label={t("form.breed.label")}>
                            <Select
                                name={"breed"}
                                placeholder={t("form.breed.placeholder")}
                                disabled={!values.species}
                            >
                                {values.species &&
                                    species &&
                                    species[values.species].breedIds.map(
                                        (breedId) => {
