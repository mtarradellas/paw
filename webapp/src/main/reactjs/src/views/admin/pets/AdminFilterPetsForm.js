    ...
    return (
        <Formik
            ...
            render={({ values, setFieldValue }) => {
                ...
                return (
                    <Form layout={"vertical"} className={"admin__container"}>
                        <div className={"form-content"}>
                            <FormItem
                                name={"species"}
                                label={t("petsFilterForm.labels.species")}
                            >
                                <Select
                                    name={"species"}
                                    onSelect={(value) =>
                                        updateFilters(value, "species")
                                    }
                                >
                            ...
                            <FormItem
                                name={"breed"}
                                label={t("petsFilterForm.labels.breed")}
                            >
                                <Select
                                    name={"breed"}
                                    onSelect={(value) =>
                                        updateFilters(value, "breed")
                                    }
                                >
                                    <Select.Option value={0}>
                                        {t("values.any")}
                            ...
                            <FormItem
                                name={"gender"}
                                label={t("petsFilterForm.labels.gender")}
                            >
                                <Select
                                    name={"gender"}
                                    onSelect={(value) =>
                                        updateFilters(value, "gender")
                                    }
                                >
                            ...
                            <FormItem
                                name={"status"}
                                label={t("petsFilterForm.labels.status")}
                            >
                                <Select name={"status"}>
                            ...
                            <FormItem
                                name={"searchCriteria"}
                                label={t("petsFilterForm.labels.criteria")}
                            >
                                <Select name={"searchCriteria"}>
                                    ...
                                    <Select.Option value={"uploadDate"}>
                                        {t("values.uploadDate")}
                                    </Select.Option>
                                </Select>
                            </FormItem>
                            ...
                            <FormItem
                                name={"searchOrder"}
                                label={t("petsFilterForm.labels.order")}
                            >
                                <Select
                                    name={"searchOrder"}
                                    disabled={values.searchCriteria === "any"}
                                >
