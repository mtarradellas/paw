                            ...
                            <FormItem name={"searchCriteria"} label={t("filterForm.labels.criteria")}>
                                {
                                    fetchingFilters ?
                                        ...
                                        <Select name={"searchCriteria"}>
                                            <SelectOption value={-1}>{t('filterForm.labels.any')}</SelectOption>
                                            <SelectOption
                                                value={'uploadDate'}>{t('filterForm.criteria.uploadDate')}</SelectOption>
                                            <SelectOption
                                                value={'gender'}>{t('filterForm.criteria.gender')}</SelectOption>
                                            <SelectOption
                                                value={'species'}>{t('filterForm.criteria.species')}</SelectOption>
                                            <SelectOption
                                                value={'breed'}>{t('filterForm.criteria.breed')}</SelectOption>
                                            <SelectOption
                                                value={'price'}>{t('filterForm.criteria.price')}</SelectOption>
                                        </Select>
                                }
                            </FormItem>
