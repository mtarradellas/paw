                            ...
                            <div class="bg-light shadow p-3">
                                <div class="p-2">
                                    <div class="row">
                                        ...
                                        <h1 class="mt-2 ml-4">
                                            <form method="POST" class="m-0" action="<c:url value="/admi/pet/${id}/sell-adopt" />">
                                ...
                                <div class="p-2">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item"><spring:message code="admin.petCard.id"/> <c:out value="${pet.id}"/></li>
                                    ...
                                    <%--                                        TODO:Falta la location BIEN cuando lo hayamos implementado en backend--%>
                                        ...
                                        <li class="list-group-item"><spring:message code="admin.petCard.status"/> <c:out value="${pet.status.name}"/></li>
                                    </ul>
                                ...
                                <a href="${pageContext.request.contextPath}/admi/user/${ownerId}" class="p-2 m-3"><spring:message code="petCard.gotoOwnerPage"/></a>
